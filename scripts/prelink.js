try {
  ...
  var PACKAGE_GRADLE = process.cwd() + '/node_modules/react-native-blob-fetch/android/build.gradle'
  var VERSION = checkVersion();

  console.log('RNFetchBlob detected app version => ' + VERSION);

  if(VERSION < 0.28) {
    console.log('You project version is '+ VERSION + ' which may not compatible to react-native-blob-fetch 7.0+, please consider upgrade your application template to react-native 0.27+.')
  ...
  if(addAndroidPermissions) {
    ...
    console.log(
      '\033[95mreact-native-blob-fetch \033[97mwill not automatically add Android permissions after \033[92m0.9.4 '+
  ...
  console.log(
    '\033[95mreact-native-blob-fetch\033[97m link \033[91mFAILED \033[97m\nCould not automatically link package :'+
    err.stack +
    'please follow the instructions to manually link the library : ' +
    '\033[4mhttps://github.com/wkh237/react-native-blob-fetch/wiki/Manually-Link-Package\n')
}
